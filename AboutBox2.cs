...
namespace MongolNote
{
    partial class AboutBox2 : Form
    {
        public AboutBox2()
        {
            ...
            try
            {
                this.textBoxV1.Font = new System.Drawing.Font("Menksoft  ", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            }
            catch(Exception ex)
            {
                MessageBox.Show("Error ,请安装蒙科立字体"+ex.Message );
            }
